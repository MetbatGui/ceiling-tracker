...
class LocalStorageAdapter(StoragePort):
    ...
    def __init__(self, base_path: str = "data"):
        ...
        logger.info(f"[LocalStorage] 초기화 완료 (Base: {self.base_path.absolute()})")
    ...
    def save_dataframe_excel(self, df: pd.DataFrame, path: str, **kwargs) -> bool:
        ...
        try:
            ...
            logger.info(f"[LocalStorage] [OK] Excel 저장: {path}")
            return True
    ...
    def save_dataframe_csv(self, df: pd.DataFrame, path: str, **kwargs) -> bool:
        ...
        try:
            ...
            logger.info(f"[LocalStorage] [OK] CSV 저장: {path}")
            return True
        except Exception as e:
    ...
    def save_workbook(self, book: openpyxl.Workbook, path: str) -> bool:
        ...
        try:
            ...
            self.ensure_directory(str(full_path.parent.relative_to(self.base_path)))
            book.save(full_path)
            logger.info(f"[LocalStorage] [OK] Workbook 저장: {path}")
            return True
        except Exception as e:
    ...
    def load_workbook(self, path: str) -> Optional[openpyxl.Workbook]:
        ...
        try:
            ...
            logger.warning(f"[LocalStorage] [Warn] 파일 없음: {path}")
            return None
        except Exception as e:
    ...
    def put_file(self, path: str, data: bytes) -> bool:
        ...
        try:
            ...
            with open(full_path, 'wb') as f:
                f.write(data)
            logger.info(f"[LocalStorage] [OK] 파일 저장: {path}")
            return True
        except Exception as e:
            logger.error(f"[LocalStorage] [Error] 파일 저장 실패 ({path}): {e}")
            return False
    ...
    def save_parquet(self, df: pd.DataFrame, path: str) -> bool:
        ...
        try:
            ...
            logger.info(f"[LocalStorage] [OK] Parquet 저장: {path}")
            return True
        except Exception as e:
...
class GoogleDriveAdapter(StoragePort):
    ...
    def load_parquet(self, path: str) -> pd.DataFrame:
        ...
        try:
            ...
            logger.error(f"[GoogleDrive] [Error] Parquet 다운로드 실패 ({path}): {e}")
            return pd.DataFrame()
